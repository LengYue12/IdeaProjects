...
public class PersonFieldTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 1.使用原始方式构造对象以及获取成员变量的数值并打印
        Person p1 = new Person("zhanfei", 30);
//        System.out.println("获取到的成员变量的数值为：" + p1.name); // zhangfei
        System.out.println("-----------------------------------");
        ...
        System.out.println("获取到的成员变量的数值为：" + field.get(object));
        System.out.println("-----------------------------------");

        // 3.使用修改指定对象中成员变量的数值后再次打印
//        p1.name = "guanyu";
