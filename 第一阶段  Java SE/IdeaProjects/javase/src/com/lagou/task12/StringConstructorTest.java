...
public class StringConstructorTest {
    ...
    public static void main(String[] args) {
        ...
        // 使用参数指定byte数组构造对象
        byte[] bArr = {48, 97, 32, 65};
        // 使用字节数组的一部分来构造对象并打印
        String str1 = new String(bArr, 0, 2);
        System.out.println("str1 = " + str1); // 0a
        // 使用整个字节数组构造对象并打印
        String str2 = new String(bArr);
        System.out.println("str2 = " + str2); // 0a A
        // 使用参数指定字符数组构造对象
        char[] cArr = {'c', 'j', '唐', '心'};
        // 使用字符数组的一部分构造对象并打印
        String str3 = new String(cArr, 1, 3);
        System.out.println("str3 = " + str3); // j唐心
        // 使用整个字符数组构造对象打印
        String str4 = new String(cArr);
        System.out.println("str4 = " + str4); // cj唐心
        // 使用字符串构造字符串对象
        String str5 = new String("唐心");
        System.out.println("str5 = " + str5); // 唐心
