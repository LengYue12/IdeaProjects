...
/*public class StringBuilderTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sb3 = " + sb3); // abcdhello    返回调用对象自己的引用，也就是返回值和调用对象是同一个字符串
        ...
        // 使用for循环删除多个字符
        for (int i = 8; i < 12; i++) {
            // 由结果可知：删除一个字符后就跳过一个字符继续删除，因为每当删除一个字符后后面的字符会向前补位，因此下标会发生变化
            //sb3.deleteCharAt(i);
            // 始终删除下标为8的字符
            sb3.deleteCharAt(8);
        }
        ...
        System.out.println("-----------------------------------------------------");
        // 7.笔试考点
        // 考点1:既然StringBuilder类的对象本身可以修改，那么为什么成员方法还有返回值呢？*/
        public class StringBuilderTest {
            public static void main(String args[]) {
